              ...
              <div className="flex sm:flex-row">
                {props.tags.map((tag, index) => (
                  <div
                    key={tag.id}
                    index={index}
                    className="text-dimWhite mr-5 text-sm hover:text-purple-300 p-1.5 ring-1 ring-dimWhite hover:ring-purple-300 rounded text-ellipsis whitespace-nowrap overflow-hidden"
                    title={tag.name}
                  >
